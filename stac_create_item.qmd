...
> `scripts/item_create.py` grew out of, and it has not been maintained since. It still
...
>
> The live path is `scripts/item_create.py`, exercised by the monthly workflow.
